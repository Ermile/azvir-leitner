...
class user
{
	...
	public static function start()
	{
		...
		$txt_start = "سلام، من ربات `_name_` هستم.\nتلاش من برای کمک به شما برای یادگیری مطالب به روشی ساده و سریع به روش لایتنر است.";
		$txt_start .= "لایتنر در واقع روش علمی یادگیری است که بر مبنای آن آموخته‌ها از حافظه‌ی کوتاه‌مدت به حافظه‌ی بلندمدت منتقل می‌شوند. \leitner ";
	...
	public static function about()
	{
		...
		[
			[
				...
				'address'   => '#83, Moallem 10, Qom, Iran +9825-3773-5183',
			],
			// [
			// 	'caption'   => $txt_caption,
			// 	'method' => 'sendPhoto',
