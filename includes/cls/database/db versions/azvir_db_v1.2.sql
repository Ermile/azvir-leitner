...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2015 at 09:42 PM
...
(1, 15, NULL, 'test1', 'test1', NULL, 'test1', NULL, NULL, 'enable', '2015-05-17 19:41:32'),
(2, 15, NULL, 'test2', 'test2', NULL, 'test2', NULL, NULL, 'enable', '2015-05-17 19:41:35');
...
--
ALTER TABLE `cardusages`
ADD CONSTRAINT `cardusages_cardcats_id` FOREIGN KEY (`cardcat_id`) REFERENCES `cardcats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
